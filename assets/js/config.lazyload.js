    ...
    .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
        $ocLazyLoadProvider.config({
            ...
            modules: [{
                    ...
                    name: 'snapscroll',
                    files: [
                      'assets/plugins/angular-snapscroll/angular-snapscroll.js'
                      
                    ]
                }, {
                    name: 'angular-slick',
                    files: [
                      'assets/plugins/angular-slick/slick-carousel/slick.css',
                      'assets/plugins/angular-slick/slick-carousel/slick-theme.css',
                      'assets/plugins/angular-slick/slick.js',
                      'assets/plugins/angular-slick/slick-carousel/slick.js'
                    ]
                }, {
                    name: 'angular-carousel',
                    files: [
                      // {type: 'js', path: 'http://maps.googleapis.com/maps/api/js?v=3&sensor=false&language=en&callback=initialize' },
                      'assets/plugins/angular-carousel/angular-touch.js',
                      'assets/plugins/angular-carousel/angular-carousel.js',
                      'assets/plugins/angular-carousel/angular-carousel.css'
                    ]
                }, {
                    name: 'truncate',
                    files: [
                      'assets/plugins/angular-truncate/truncate.js'
                    ]
                }, {
                    name: 'ng-map',
                    files: [
                      // {type: 'js', path: 'http://maps.googleapis.com/maps/api/js?v=3&sensor=false&language=en&callback=initialize' },
                      'assets/plugins/ng-map/ng-map.js'
                    ...
                    files: [
                      ...
                      'assets/js/services/jsonService.js',
                      'assets/js/services/menuService.js',
                      'assets/js/services/stateService.js'
